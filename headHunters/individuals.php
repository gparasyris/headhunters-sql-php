            ...
            <div class="wrapper group">
                ...
                <div id="content" class="layout-sidebar-right group">
                    ...
                    <div id="slogan" class="inner">
                        <h1 class="only">This is registered <span>Personnel</span> page</h1>
                    </div>         
                    <!-- END SLOGAN --> 
                    ...
                    <div id="primary" class="hentry group wrapper-content" role="main">
                        ...
                        <h2 class="title-post-page">Personnel</h2>

                        <div class="archive-list">
                            <h3 class="no-cufon">Sorted alphabetically:</h3>
...
<?php
	...
	$query = MYSQL_QUERY("SELECT * FROM customer, individual WHERE customer.id=individual.id ORDER BY name");

	while($row = mysql_fetch_array($query)){
?>	
                                <li><a href="#" title="Another great theme for your corporate site!" rel="bookmark">
									<?php echo $row[1];?>
                                    <?php echo ', '.$row[11].', '.$row[2].', Tel.'.$row[3].', e-mail: '.$row[4];?>
                                </a></li>
<?php
	}
?>							
