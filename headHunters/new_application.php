        ...
        <div class="shadowBg group">
            ...
            <div class="wrapper group">
                ...
                <div id="content" class="layout-sidebar-right group">
					...
					<!--
					<table style="width:100%" cellpadding="0" cellspacing="0" class="short-table blue">
                            <thead>
                                <tr>
                                    <th style="width:30%">Position's Code</th>             
                                    <th style="width:30%">Company's Name</th>              
                                    <th style="width:40%">Position's Description</th>              
                                </tr>
                            </thead>
					...
					//$query = MYSQL_QUERY("SELECT isoffered.jobCode, customer.name, jobposition.description FROM isoffered, jobposition, customer WHERE jobposition.available = 1 AND (GETDATE() <= isoffered.deadline OR isoffered.deadline = '0000-00-00') AND isoffered.jobCode = jobposition.code AND customer.id =  isoffered.companyId");
					$query = MYSQL_QUERY("SELECT isoffered.jobCode, customer.name, jobposition.description FROM isoffered, jobposition, customer WHERE jobposition.available = 1 AND isoffered.jobCode = jobposition.code AND customer.id =  isoffered.companyId AND (isoffered.deadline = '0000-00-00')");
...
-->
                        ...
                        <form class="contact-form" method="post" action="insert_new_application.php" enctype="multipart/form-data">
                        	...
                        	<fieldset>
                        		<ul>
									...
									<li class="text-field">
                        				...
                        				<input type="text" name="individualName" id="name-form" class="required" value="" />                   
                        				<div class="msg-error"></div>
                        			</li>
                        			<li class="text-field">
                        				<label for="name-main">
                        					<span class="label">You will be available <span class="highlight-text">until</span>:</span>
                        				</label>
                        				
                        				<input type="date" name="date" id="name-form" class="required" value="" />                   
                        				<div class="msg-error"></div>
                        			</li>
