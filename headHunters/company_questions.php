            ...
            <div class="wrapper group">
                ...
                <div id="content" class="layout-sidebar-right group">
                    ...
                    <div id="slogan" class="inner">
                        <h1 class="only">Unemployed Personnel</h1>
                    </div>         
                    <!-- END SLOGAN --> 
                    ...
                    <div id="primary" class="hentry group wrapper-content" role="main">
                        ...
                        <h2 class="title-post-page">Here you can find unemployed personnel.</h2>
					...
					$query = MYSQL_QUERY("SELECT customer.name, individual.job, customer.email FROM customer, individual WHERE customer.id =  individual.id AND individual.unemployed=1");
