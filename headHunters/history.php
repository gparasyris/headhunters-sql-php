...
<?php
	...
	$q = MYSQL_QUERY("SELECT COUNT(*) as a FROM jobposition WHERE available=0");
	$r = mysql_fetch_array($q);
	$count1 = $r['a'];
	
	$query = MYSQL_QUERY("SELECT code, description FROM jobposition WHERE available=0");
	...
	<?php
						MYSQL_QUERY("SET NAMES 'utf8'");
						$q2 = MYSQL_QUERY("SELECT COUNT(*) as o FROM jobposition WHERE available = 1");
						$r2 = mysql_fetch_array($q2);
						$count2 = $r2['o'];
						
						$query2 = MYSQL_QUERY("SELECT code, description FROM jobposition WHERE available = 1");

						while($row2 = mysql_fetch_array($query2)){
	?>
							<li><?php echo $row2[0].', '.$row2[1];?></li>
	<?php
	}
	?>	
                        </ul>
						...
						<h2>Statistics</h2>
						<ul class="short arrow">
							<li>Available Positions: <?php echo $count2.' ('.number_format(($count2/($count1 + $count2))*100, 2, '.', '').' %)';?></li>
							<li>Occupied Positions: <?php echo $count1.' ('.number_format(($count1/($count1 + $count2))*100, 2, '.', '').' %)';?></li>
							<li>Total Positions: <?php echo $count2+$count1;?></li>
						</ul>
						
                        <div class="nivo-slider" style="width:558px; height:331px">
                            <img src="images/nivo-slider/001.jpg" alt="1" />
                            <img src="images/nivo-slider/002.jpg" alt="2" />
                            <img src="images/nivo-slider/003.jpg" alt="3" />
                            <img src="images/nivo-slider/004.jpg" alt="4" />
                            <img src="images/nivo-slider/005.jpg" alt="5" />
                        </div>
